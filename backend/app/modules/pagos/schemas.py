...
from app.modules.pedidos.schemas import CrearPedidoRequest, PedidoRead
...
class CrearPedidoMercadoPagoRequest(BaseSchema):
...
class PedidoMercadoPagoResponse(BaseSchema):
    pedido: PedidoRead
    pago: PagoRead
