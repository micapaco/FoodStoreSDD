...
- **THEN** routes `/perfil`, `/carrito`, `/checkout`, `/pedidos` and `/pedidos/:id` are defined under the private layout
...
- **WHEN** routes `/perfil`, `/carrito`, `/checkout`, `/pedidos`, `/pedidos/:id` are declared
