...
- **THEN** cada tarjeta muestra: número de pedido, lista de ítems con `nombre_snapshot` × `cantidad`, exclusiones de ingredientes de `personalizacion`, `notas` del cliente y el timer de urgencia
