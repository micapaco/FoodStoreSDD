...
**Próximo change:** `15 — order-views` (ver `docs/CHANGES.md`).
...
→ Leer `backend/AGENTS.md` antes de operar.
...
→ Leer `frontend/AGENTS.md` antes de operar.
